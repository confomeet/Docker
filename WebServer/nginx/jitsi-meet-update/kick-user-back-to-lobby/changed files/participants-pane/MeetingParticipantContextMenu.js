...
import { participantIsKnockingOrUpdated, startKnocking } from '../../../lobby/actions';
import { GrantModeratorDialog, KickRemoteParticipantDialog, KickToLobbyDialog, MuteEveryoneDialog } from '../../../video-menu';
import MuteRemoteParticipantsVideoDialog from '../../../video-menu/components/web/MuteRemoteParticipantsVideoDialog';
import AllowToSignDocumentDialog from '../../../video-menu/components/web/AllowToSignDocumentDialog';
...
class MeetingParticipantContextMenu extends Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this._onSignDocument = this._onSignDocument.bind(this);
    }
    ...
    _onSignDocument: () => void;

    /**
     * Sign document by the selected participant.
     *
     * @returns {void}
     */
     _onSignDocument() {
        ...
        dispatch(openDialog(AllowToSignDocumentDialog, {
            participantID: _participant?.id
        }));
    }
            ...
            <ContextMenu
                ...
                <ContextMenuItemGroup>
                    ...
                    {/* {
                        _isLocalModerator && (
                            <>
                                <ContextMenuItem onClick = { this._onSignDocument }>
                                    <ContextMenuIcon src = { IconCheck } />
                                    <span>{ t('videothumbnail.AllowToSign') }</span>
                                </ContextMenuItem>
