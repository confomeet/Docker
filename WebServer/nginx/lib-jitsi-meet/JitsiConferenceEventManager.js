...
JitsiConferenceEventManager.prototype.setupChatRoomListeners = function() {
   ...
   this.chatRoomForwarder.forward(XMPPEvents.ROOM_CONNECT_DUPLICATE_ACCESS_ERROR,
        JitsiConferenceEvents.CONFERENCE_FAILED,
        JitsiConferenceErrors.DUPLICATE_ACCESS_ERROR);
    ...
    chatRoom.addListener(XMPPEvents.JSON_MESSAGE_RECEIVED,
        ...
        chatRoom.addListener(XMPPEvents.KICK_BACK_TO_LOBBY_RECEIVED,
            lobbyroom => {
                logger.info(`You have been kicked back to lobby (${lobbyroom})`);
                conference.eventEmitter.emit(JitsiConferenceEvents.KICK_BACK_TO_LOBBY_RECEIVED, lobbyroom);
        });
