...
var config = {
    ...
    hosts: {
        ...
        // anonymousdomain: 'guest.${XMPP_DOMAIN}',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'auth.${XMPP_DOMAIN}',
    ...
    bosh: '//${XMPP_DOMAIN}/http-bind',

    // base url used to get data from ccms system
    ccms_base_url: '${CCMS_BASE_URL}',

    // Websocket URL (XMPP)
    // websocket: 'wss://${XMPP_DOMAIN}/xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.${XMPP_DOMAIN}',
    ...
    //     // by default uses:
    //     // 'https://${XMPP_DOMAIN}/static/oauth.html'
    //     redirectURI:
    ...
    */
    ...
    etherpad_base: 'https://${XMPP_DOMAIN}/etherpad/p/',
    ...
    */
    ...
    whiteboard: {
       ...
       collabServerBaseUrl: 'https://${XMPP_DOMAIN}',
    },
    ...
    hiddenDomain: 'recorder.${XMPP_DOMAIN}',
    peopleSearchQueryTypes:['conferenceRooms'],
    peopleSearchUrl:'https://${XMPP_DOMAIN}/sip.json'
};
